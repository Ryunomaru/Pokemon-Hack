...
Neu können auch die Daten der Weltkarte geändert werden.


!!!Achtung!!!
-------------
Bei dieser Version werden alle änderungen direkt ins Rom gespeichert!
...
Alle weiteren änderungen werden dann in die neue Datei gespeichert.
